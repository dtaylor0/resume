...
function Chat() {
    ...
    return (
        <>
            <button onClick={() => setIsVisible(!isVisible)}>Chat</button>
            {isVisible && (
                <div id="chat" className="rounded-lg mt-3">
                    <div
                        ref={chatContainerRef}
                        id="messages"
                        className="overflow-y-auto min-h-0 scrollbar-hidden"
                    >
                    ...
                    >
                        <form id="chat-form" onSubmit={handleSubmit}>
                            <div className="flex">
                                ...
                                ></textarea>
                                <button
                                    className="p-2 m-1 rounded-lg ml-auto h-10"
                                    id="form-button"
                                    type="submit"
                                >
                                    Send
